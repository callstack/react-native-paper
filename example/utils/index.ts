...
export const songsData = [
  {
    ...
    cover: require('../src/assets/screenshots/song-1.jpg'),
    id: '0',
    title: 'Song title no 0',
  },
  {
    artist: 'The artist no 1',
    cover: require('../src/assets/screenshots/song-2.jpg'),
    id: '1',
...
export const albumsData = [
  {
    ...
    cover: require('../src/assets/screenshots/artist-1.jpg'),
    id: '0',
    title: 'Album title no 0',
  },
  {
    artist: 'The artist no 1',
    cover: require('../src/assets/screenshots/artist-2.jpg'),
    id: '1',
...
export const restaurantsData = [
  {
    cover: require('../src/assets/screenshots/restaurant-1.jpg'),
    id: '0',
    name: 'Restaurant no 0',
    price: 1,
  },
  {
    cover: require('../src/assets/screenshots/restaurant-2.jpg'),
    id: '1',
