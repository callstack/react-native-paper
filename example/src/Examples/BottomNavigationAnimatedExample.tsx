...
const BottomNavigationAnimatedExample = () => {
  const { isV3 } = useTheme();
...
BottomNavigationAnimatedExample.title =
  'Bottom Navigation w/ shifting animation';

export default BottomNavigationAnimatedExample;
