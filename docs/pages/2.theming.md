...
The Dark theme adds a white overlay with opacity depends on elevation to surfaces. It uses it for the better accentuation of surface elevation. Using the only shadow is highly imperceptible on dark surfaces.
