...
**Warning**: TypeScript support for withTheme is currently limited to Material You theme only. We are planning to provide a better support of handling custom theme overrides in future releases.
