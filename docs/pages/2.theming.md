...
By default React Native Paper will apply the [default theme](https://github.com/callstack/react-native-paper/blob/main/src/styles/DefaultTheme.tsx) if no `theme` or `version` prop is passed to to the `Provider`.
...
If you are migrating from Material Design 2 (4.x and lower) to Material You (5.x), please refer to our [Migration Guide](./10.migration-guide-to-5.0.md)
