...
There was also introduced prop `compact`, working with both themes, indicating whether tabs should be spread across the entire width, especially in <i>horizontal</i> mode. 
