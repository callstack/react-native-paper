...
Paper now supports both Material Design 2 and 3 through the configuration described in [Versioning](#versioning) and is compatible with a handful of API change. 
...
Read more about using Material Design 2 in our [Material Design 2 theming guide](./2.theming.md#material-design-2)
