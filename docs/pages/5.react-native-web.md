...
You can also load this font using [`css-loader`](https://github.com/webpack-contrib/css-loader) and include the stylesheet via:
```js
import 'react-native-paper/assets/css/icons.css';
```
...
If you need this font in an offline scenario and want to take control on how the font is cached, you can also load this font using [`css-loader`](https://github.com/webpack-contrib/css-loader) and include the stylesheet via:
```js
import 'react-native-paper/assets/css/fonts.css';
```
