...
If you're on a vanilla React Native project below version 0.60, you also need to install and link [react-native-vector-icons](https://github.com/oblador/react-native-vector-icons).
