...
If you do not use react-navigation, you will need to install [react-native-safe-area-view](https://github.com/react-native-community/react-native-safe-area-view#installation) and wrap the root of your application with a `SafeAreaProvider`.
