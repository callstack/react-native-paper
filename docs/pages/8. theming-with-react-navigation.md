...
In order for our themes to work together, both libraries require a wrapper to be used in the entry point of the application.
...
Alternatively, we could merge those themes with vanilla JavaScript
...
## Using React Context for theme customization
