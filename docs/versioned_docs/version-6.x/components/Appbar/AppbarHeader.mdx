...
It can contain the screen title, controls such as navigation buttons, menu button etc.
  ...
  <ScreenshotTabs screenshotData={{"small":"screenshots/appbar-small.png","medium":"screenshots/appbar-medium.png","large":"screenshots/appbar-large.png","center-aligned":"screenshots/appbar-center-aligned.png"}} baseUrl="/"/>
