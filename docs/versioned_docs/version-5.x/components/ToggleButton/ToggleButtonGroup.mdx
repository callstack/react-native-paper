...
### onValueChange (required) 
  ...
  <PropTable componentLink="ToggleButton/ToggleButtonGroup" prop="onValueChange" />
...
### value (required) 
  ...
  <PropTable componentLink="ToggleButton/ToggleButtonGroup" prop="value" />
...
### children (required) 
  ...
  <PropTable componentLink="ToggleButton/ToggleButtonGroup" prop="children" />
