module.exports = [
            ...
            value: function render() {
              ...
              return /*#__PURE__*/ React.createElement(
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  " library to render correctly. If you're using Expo, you don't need to do anything extra, but if it's a vanilla React Native project, you need link the library as described in the getting started guide.",
                ),
                /*#__PURE__*/ React.createElement(
                  _tag.MDXTag,
                  {
                  ...
                  ", you won't be able to use icon names for the icon prop. Some components may not look correct without vector icons and might need extra configuration.",
                ),
                /*#__PURE__*/ React.createElement(
                  _tag.MDXTag,
                  {
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  " prop supports the following types of values:",
                ),
                /*#__PURE__*/ React.createElement(
                  _tag.MDXTag,
                  {
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  " properties as its arguments. The element is used as is without any modification. However, it might get clipped if the provided element's size is bigger than what the component renders. It's up to you to make sure that the size of the element is correct.",
                ),
                /*#__PURE__*/ React.createElement(
                  _tag.MDXTag,
                  {
                ...
                /*#__PURE__*/ React.createElement(
                  ...
                  "If you want to use icons other than ",
                  /*#__PURE__*/ React.createElement(
                    _tag.MDXTag,
                    {
                      name: "inlineCode",
                  ...
                  " you need to import the icons and pass it to the ",
                  /*#__PURE__*/ React.createElement(
                    _tag.MDXTag,
                    {
                      name: "inlineCode",
  ...
  { type: "separator" },
  {
    ...
    data: {
      ...
      props: {
        ...
        theme: {
          required: true,
          tsType: { name: "ReactNativePaper.Theme" },
  ...
  {
    filepath: "../src/components/FAB/AnimatedFAB/AnimatedFAB.tsx",
    title: "AnimatedFAB",
    description: "",
    link: "animated-fab",
    data: {
      ...
      props: {
        ...
        accessibilityLabel: {
          ...
          defaultValue: { value: "label", computed: true },
        },
        accessibilityState: {
          required: false,
          tsType: { name: "AccessibilityState" },
          description:
        ...
        iconMode: {
          ...
          defaultValue: { value: "'dynamic'", computed: false },
        },
        animateFrom: {
          required: false,
          tsType: {
    ...
    type: "component",
    dependencies: [
      "/Users/drakeoon/Desktop/Dev/projects/react-native-paper/src/components/FAB/AnimatedFAB/AnimatedFAB.tsx",
    ],
  },
  {
    ...
    data: {
      ...
      props: {
        color: {
          ...
          defaultValue: {
            value: "color(black).alpha(0.54).rgb().string()",
            computed: true,
          },
        },
        icon: {
    ...
    data: {
      ...
      props: {
        color: {
          ...
          defaultValue: { value: "white", computed: true },
        },
        title: {
          required: true,
          tsType: { name: "ReactReactNode", raw: "React.ReactNode" },
      ...
      props: {
        source: {
          ...
          tsType: {
            ...
            elements: [{ name: "ImageSourcePropType" }, { name: "unknown" }],
          },
          description:
        ...
        onLoad: {
          required: false,
          tsType: { name: "ImageProps['onLoad']", raw: "ImageProps['onLoad']" },
    ...
    data: {
      ...
      props: {
                    ...
                    elements: [
                      {
                        ...
                        raw: "React.ComponentProps<typeof Button>",
                        elements: [{ name: "Button" }],
                      },
                      { name: "literal", value: "'children'" },
                    ],
                    raw: "Omit<React.ComponentProps<typeof Button>, 'children'>",
                  },
                ],
              },
            ],
        ...
        onShowAnimationFinished: {
          required: false,
          tsType: { name: "Animated.EndCallback" },
          description:
  ...
  {
    filepath: "../src/components/BottomNavigation/BottomNavigation.tsx",
    ...
    data: {
      ...
      props: {
        shifting: {
          ...
          defaultValue: {
            value: "navigationState.routes.length > 3",
            computed: false,
          },
        },
        labeled: {
        ...
        renderTouchable: {
          ...
          defaultValue: {
            value: "(props: TouchableProps) => <Touchable {...props} />",
            computed: false,
          },
        },
        getLabelText: {
        ...
        safeAreaInsets: {
          ...
          tsType: {
            ...
            signature: {
              properties: [
                { key: "top", value: { name: "number", required: false } },
                { key: "right", value: { name: "number", required: false } },
                { key: "bottom", value: { name: "number", required: false } },
                { key: "left", value: { name: "number", required: false } },
              ],
            },
          },
          description:
    ...
    type: "component",
    dependencies: [
      "/Users/drakeoon/Desktop/Dev/projects/react-native-paper/src/components/BottomNavigation/BottomNavigation.tsx",
    ],
  },
  {
      ...
      props: {
        elevation: {
          ...
          tsType: {
            name: "union",
            raw: "never | number",
            elements: [{ name: "never" }, { name: "number" }],
          },
          description:
      ...
      props: {
        ...
        position: {
          ...
          tsType: {
            ...
            elements: [
              { name: "literal", value: "'leading'" },
              { name: "literal", value: "'trailing'" },
            ],
          },
          description: "Checkbox control position.",
          defaultValue: { value: "'trailing'", computed: false },
        },
        mode: {
          required: false,
          tsType: {
            ...
            raw: "'android' | 'ios'",
            elements: [
              { name: "literal", value: "'android'" },
              { name: "literal", value: "'ios'" },
            ],
          },
          description:
      ...
      props: {
        ...
        onItemsPerPageChange: {
          ...
          tsType: {
            ...
            signature: {
              arguments: [
                { name: "numberOfItemsPerPage", type: { name: "number" } },
              ],
              return: { name: "void" },
            },
          },
    ...
    data: {
      ...
      props: {
        ...
        overlayAccessibilityLabel: {
          ...
          defaultValue: { value: "'Close modal'", computed: false },
        },
        visible: {
          required: false,
          tsType: { name: "boolean" },
  ...
  },
  {
    ...
    data: {
      ...
      props: {
        ...
        label: {
          required: false,
          tsType: { name: "TextInputLabelProp" },
          description: "The text or component to use for the floating label.",
        },
        placeholder: {
          required: false,
          tsType: { name: "string" },
        ...
        underlineColor: {
          required: false,
          tsType: { name: "string" },
          description: "Inactive underline color of the input.",
        },
        activeUnderlineColor: {
          required: false,
          tsType: { name: "string" },
          description: "Active underline color of the input.",
        },
        outlineColor: {
          required: false,
          tsType: { name: "string" },
          description: "Inactive outline color of the input.",
        },
        activeOutlineColor: {
          required: false,
          tsType: { name: "string" },
          description: "Active outline color of the input.",
        },
        dense: {
          required: false,
          tsType: { name: "boolean" },
  ...
  {
    filepath: "../src/components/TextInput/Adornment/TextInputAffix.tsx",
    title: "TextInput.Affix",
    description:
      'A component to render a leading / trailing text in the TextInput\n\n<div class="screenshots">\n  <figure>\n    <img class="medium" src="screenshots/textinput-outline.affix.png" />\n  </figure>\n</div>\n\n## Usage\n```js\nimport * as React from \'react\';\nimport { TextInput } from \'react-native-paper\';\n\nconst MyComponent = () => {\n  const [text, setText] = React.useState(\'\');\n\n  return (\n    <TextInput\n      mode="outlined"\n      label="Outlined input"\n      placeholder="Type something"\n      right={<TextInput.Affix text="/100" />}\n    />\n  );\n};\n\nexport default MyComponent;\n```',
    link: "text-input-affix",
    data: {
      description:
        'A component to render a leading / trailing text in the TextInput\n\n<div class="screenshots">\n  <figure>\n    <img class="medium" src="screenshots/textinput-outline.affix.png" />\n  </figure>\n</div>\n\n## Usage\n```js\nimport * as React from \'react\';\nimport { TextInput } from \'react-native-paper\';\n\nconst MyComponent = () => {\n  const [text, setText] = React.useState(\'\');\n\n  return (\n    <TextInput\n      mode="outlined"\n      label="Outlined input"\n      placeholder="Type something"\n      right={<TextInput.Affix text="/100" />}\n    />\n  );\n};\n\nexport default MyComponent;\n```',
      displayName: "TextInput.Affix",
      methods: [],
      statics: [],
      props: {
        text: {
        ...
        onLayout: {
          ...
          tsType: {
            name: "signature",
            type: "function",
            raw: "(event: LayoutChangeEvent) => void",
            signature: {
              arguments: [
                { name: "event", type: { name: "LayoutChangeEvent" } },
              ],
              return: { name: "void" },
            },
          },
        ...
        textStyle: {
          ...
          description: "Style that is passed to the Text element.",
        },
        theme: {
          required: true,
          tsType: { name: "ReactNativePaper.Theme" },
    ...
    type: "component",
    dependencies: [
      "/Users/drakeoon/Desktop/Dev/projects/react-native-paper/src/components/TextInput/Adornment/TextInputAffix.tsx",
    ],
    group: "TextInput",
  },
  {
    filepath: "../src/components/TextInput/Adornment/TextInputIcon.tsx",
    ...
    data: {
      ...
      props: {
        ...
        forceTextInputFocus: {
          required: false,
          tsType: { name: "boolean" },
          description: "Whether the TextInput will focus after onPress.",
          defaultValue: { value: "true", computed: false },
        },
        color: {
          required: false,
          tsType: {
            name: "union",
            raw: "((isTextInputFocused: boolean) => string | undefined) | string",
            elements: [{ name: "unknown" }, { name: "string" }],
          },
          description:
    ...
    type: "component",
    dependencies: [
      "/Users/drakeoon/Desktop/Dev/projects/react-native-paper/src/components/TextInput/Adornment/TextInputIcon.tsx",
    ],
    group: "TextInput",
  },
  {
  ...
  {
    filepath: "../src/components/TouchableRipple/TouchableRipple.tsx",
    ...
    type: "component",
    dependencies: [
      "/Users/drakeoon/Desktop/Dev/projects/react-native-paper/src/components/TouchableRipple/TouchableRipple.tsx",
    ],
  },
  {
