...
[`pchmn/expo-material3-theme`](https://github.com/pchmn/expo-material3-theme) library allows you to retrieve the Material 3 system colors from Android 12+ devices and sync them with your dynamic theme. If user changes the system colors, the theme will be updated automatically. For devices not compatible the library will fallback to a default theme.
Follow [installation instructions](https://github.com/pchmn/expo-material3-theme#installation), then use it like this:
