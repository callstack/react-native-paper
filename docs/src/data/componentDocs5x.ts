const componentDocs5x = {
  "docs": {
              ...
              "elements": [
                {
                  ...
                  "elements": [
                    ...
                    },
                    {
                      ...
                      "raw": "$RemoveChildren<typeof Button>"
                    }
                  ]
                }
              ],
        ...
        "props": {
          ...
          "renderTouchable": {
            ...
            "tsType": {
              "name": "signature",
              "type": "function",
              "raw": "(props: TouchableProps<Route>) => React.ReactNode",
              "signature": {
                "arguments": [
                  {
                    "name": "props",
      ...
      "data": {
        ...
        "props": {
          ...
          "renderTouchable": {
            ...
            "description": "Callback which returns a React element to be used as the touchable for the tab item.\nRenders a `TouchableRipple` on Android and `Pressable` on iOS.",
            "defaultValue": {
              "value": "({ key, ...props }: TouchableProps<Route>) => (\n  <Touchable key={key} {...props} />\n)",
              "computed": false
            }
          },
          "getAccessibilityLabel": {
      ...
      "data": {
        ...
        "props": {
          "title": {
            ...
            "description": "Text for the title. Note that this will only accept a string or `<Text>`-based node."
          },
          "titleStyle": {
            "required": false,
            "tsType": {
          ...
          "subtitle": {
            ...
            "description": "Text for the subtitle. Note that this will only accept a string or `<Text>`-based node."
          },
          "subtitleStyle": {
            "required": false,
            "tsType": {
      ...
      "data": {
        ...
        "props": {
          ...
          "mode": {
            ...
            "description": "Whether `<Checkbox.Android />` or `<Checkbox.IOS />` should be used.\nLeft undefined `<Checkbox />` will be used."
          },
          "hitSlop": {
            "required": false,
            "tsType": {
      ...
      "data": {
        ...
        "props": {
          ...
          "mode": {
            ...
            "description": "Whether `<RadioButton.Android />` or `<RadioButton.IOS />` should be used.\nLeft undefined `<RadioButton />` will be used."
          },
          "position": {
            "required": false,
            "tsType": {
    ...
    "SegmentedButtons/SegmentedButtons": {
      ...
      "description": "Segmented buttons can be used to select options, switch views or sort elements.</br>\n\n## Usage\n```js\nimport * as React from 'react';\nimport { SafeAreaView, StyleSheet } from 'react-native';\nimport { SegmentedButtons } from 'react-native-paper';\n\nconst MyComponent = () => {\n  const [value, setValue] = React.useState('');\n\n  return (\n    <SafeAreaView style={styles.container}>\n      <SegmentedButtons\n        value={value}\n        onValueChange={setValue}\n        buttons={[\n          {\n            value: 'walk',\n            label: 'Walking',\n          },\n          {\n            value: 'train',\n            label: 'Transit',\n          },\n          { value: 'drive', label: 'Driving' },\n        ]}\n      />\n    </SafeAreaView>\n  );\n};\n\nconst styles = StyleSheet.create({\n  container: {\n    flex: 1,\n    alignItems: 'center',\n  },\n});\n\nexport default MyComponent;\n```",
      ...
      "data": {
        ...
        "props": {
          ...
          "left": {
            ...
            "description": "The adornment placed on the left side of the input. It can be either `TextInput.Icon` or `TextInput.Affix`."
          },
          "right": {
            "required": false,
            "tsType": {
            ...
            "description": "The adornment placed on the right side of the input. It can be either `TextInput.Icon` or `TextInput.Affix`."
          },
          "disabled": {
            "required": false,
            "tsType": {
            ...
            "description": "If true, user won't be able to interact with the component.",
            "defaultValue": {
              "value": "false",
              "computed": false
            }
          ...
          "selectionColor": {
            ...
            "description": "Selection color of the input. On iOS, it sets both the selection color and cursor color.\nOn Android, it sets only the selection color."
          },
          "cursorColor": {
            "required": false,
            "tsType": {
          ...
          "textColor": {
            ...
            "description": "Color of the text in the input."
          },
          "dense": {
            "required": false,
            "tsType": {
          ...
          "render": {
            ...
            "description": "Callback to render a custom input component such as `react-native-text-input-mask`\ninstead of the default `TextInput` component from `react-native`.\n\nExample:\n```js\n<TextInput\n  label=\"Phone number\"\n  render={props =>\n    <TextInputMask\n      {...props}\n      mask=\"+[00] [000] [000] [000]\"\n    />\n  }\n/>\n```",
            "defaultValue": {
          ...
          "style": {
            ...
            "description": "Pass `fontSize` prop to modify the font size inside `TextInput`.\nPass `height` prop to set `TextInput` height. When `height` is passed,\n`dense` prop will affect only input's `paddingVertical`.\nPass `paddingHorizontal` to modify horizontal padding.\nThis can be used to get MD Guidelines v1 TextInput look."
          },
          "theme": {
            "required": false,
            "tsType": {
          ...
          "contentStyle": {
            ...
            "description": "Pass custom style directly to the input itself.\nOverrides input style\nExample: `paddingLeft`, `backgroundColor`"
          },
          "outlineStyle": {
            "required": false,
            "tsType": {
          ...
          "underlineStyle": {
            ...
            "description": "Pass style to override the default style of underlined wrapper.\nOverrides style when mode is set to `flat`\nExample: `borderRadius`, `borderColor`"
          },
          "editable": {
            "defaultValue": {
              "value": "true",
    ...
    "TextInput/Adornment/TextInputAffix": {
      "filepath": "TextInput/Adornment/TextInputAffix.tsx",
      "title": "TextInput.Affix",
      "description": "A component to render a leading / trailing text in the TextInput\n\n## Usage\n```js\nimport * as React from 'react';\nimport { TextInput } from 'react-native-paper';\n\nconst MyComponent = () => {\n  const [text, setText] = React.useState('');\n\n  return (\n    <TextInput\n      mode=\"outlined\"\n      label=\"Outlined input\"\n      placeholder=\"Type something\"\n      right={<TextInput.Affix text=\"/100\" />}\n    />\n  );\n};\n\nexport default MyComponent;\n```",
      ...
      "data": {
        ...
        "props": {
          ...
          "accessibilityLabel": {
            ...
            "description": "Accessibility label for the affix. This is read by the screen reader when the user taps the affix.",
            "defaultValue": {
              "value": "text",
              "computed": true
            }
    ...
    "TextInput/Adornment/TextInputIcon": {
      "filepath": "TextInput/Adornment/TextInputIcon.tsx",
      ...
      "data": {
        ...
        "props": {
          "icon": {
            ...
            "description": "@renamed Renamed from 'name' to 'icon` in v5.x\nIcon to show."
          },
          "onPress": {
            "required": false,
            "tsType": {
          ...
          "color": {
            ...
            "description": "Color of the icon or a function receiving a boolean indicating whether the TextInput is focused and returning the color."
          },
          "rippleColor": {
            "required": false,
            "tsType": {
