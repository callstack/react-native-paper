...
Data tables allow displaying sets of data.
  ...
  <ScreenshotTabs screenshotData={"screenshots/data-table-full-width.png"} baseUrl="/react-native-paper/"/>
...
### children (required) 
  ...
  <PropTable componentLink="DataTable/DataTable" prop="children" version="5.x" />
...
### style  
  ...
  <PropTable componentLink="DataTable/DataTable" prop="style" version="5.x" />
