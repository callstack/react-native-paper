...
import { red300 } from '../../styles/themes/v3/baseColors';
...
it('renders custom background color passed to barStyle property', () => {
  ...
  expect(wrapper).toHaveStyle({ backgroundColor: '#e57373' });
});
...
describe('getActiveTintColor', () => {
  it.each`
    ...
    ${'#FBF7DB'} | ${'#FBF7DB'}
    ${undefined} | ${getTheme(false).colors.onSecondaryContainer}
  `(
...
describe('getInactiveTintColor', () => {
  it.each`
    ...
    ${'#853D4B'}  | ${'#853D4B'}
    ${undefined}  | ${getTheme(false).colors.onSurfaceVariant}
  `(
...
describe('getLabelColor', () => {
  it.each`
    ...
    ${'#FBF7DB'} | ${true}  | ${'#FBF7DB'}
    ${'#853D4B'} | ${true}  | ${'#853D4B'}
    ${undefined} | ${true}  | ${getTheme(false).colors.onSurface}
    ${undefined} | ${false} | ${getTheme(false).colors.onSurfaceVariant}
  `(
