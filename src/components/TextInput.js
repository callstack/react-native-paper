...
class TextInput extends Component<DefaultProps, Props, State> {
    ...
    render() {
        ...
        let helper = this.props.helperText ? (<Text style = {this.props.helperTextStyle}>{this.props.helperText}</Text>) : (null);
        let error = this.props.errorText ? (<Text style = {this.props.errorTextStyle}>{this.props.errorText}</Text>) : (null);
...
TextInput.defaultProps = {
    errorTextStyle: {color: '#f00', fontWeight: '400'},
    helperTextStyle: {color: '#505050', fontWeight: '400'}
}
