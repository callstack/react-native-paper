...
const Chip = ({
  ...
  const isTouchableEvent = useIsTouchableEvent({ onPress, onLongPress });
  ...
  return (
    ...
    >
      <TouchableRipple
        ...
        onPress={onPress}
        onPressIn={isTouchableEvent ? handlePressIn : undefined}
        onPressOut={isTouchableEvent ? handlePressOut : undefined}
